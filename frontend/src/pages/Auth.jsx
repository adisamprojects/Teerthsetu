...
export default function Auth() {
  ...
  const handleRequestLoginOtp = () => {
    ...
    fetch('https://teerthsetu.onrender.com/api/devotee/send-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleVerifyOtp = () => {
    ...
    fetch('https://teerthsetu.onrender.com/api/devotee/verify-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#1A1A2E] text-slate-900 dark:text-white flex items-center justify-center p-6 relative transition-colors duration-300 overflow-hidden">
      ...
      >
        ...
        <div className="w-full md:w-7/12 p-8 flex flex-col justify-center relative bg-white/40 dark:bg-transparent overflow-hidden">
          <div
            className="absolute inset-0 z-0 opacity-50 dark:opacity-50 pointer-events-none blur-sm"
            style={{
