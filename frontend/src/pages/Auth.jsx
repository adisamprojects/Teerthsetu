              ...
              <>
                ...
                {isLogin && (
                  <div className="flex justify-center gap-6 mb-6 text-sm">
                    ...
                    <button
                      type="button"
                      className={`pb-1 border-b-2 font-serif font-bold text-base transition-colors ${loginMethod === 'phone' ? (role === 'admin' ? 'border-emerald-700 text-emerald-700 dark:border-emerald-400 dark:text-emerald-400' : 'border-red-900 text-red-900 dark:border-saffron dark:text-saffron') : (role === 'admin' ? 'border-transparent text-emerald-800 dark:text-white hover:text-emerald-700 dark:hover:text-emerald-200' : 'border-transparent text-red-900 dark:text-white hover:text-red-800 dark:hover:text-slate-200')}`}
        ...
        {showForgot && (
          ...
          >
            <motion.div
              ...
              className="w-full max-w-md bg-white dark:bg-[#1A1A2E] border border-slate-200 dark:border-white/10 rounded-2xl p-6 shadow-2xl"
            >
              <h4 className="text-xl font-bold mb-2 text-slate-900 dark:text-white">Reset Password</h4>
                ...
                <form onSubmit={handleForgotSubmit} className="flex flex-col gap-4">
                  ...
                  <div className="flex gap-4 mt-2">
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-xl border border-slate-200 dark:border-white/10 text-slate-700 dark:text-slate-300 font-semibold hover:bg-slate-100 dark:hover:bg-white/10 transition-all"
                    >
                      Cancel
                    </button>
                    <button
                      type="submit"
                      className={`flex-1 py-2.5 rounded-xl font-bold transition-all ${role === 'admin' ? 'bg-emerald-600 hover:bg-emerald-500 text-white' : 'bg-saffron text-slate-900 dark:text-white hover:bg-[#e85a28]'}`}
                    >
                      Send Code
                    </button>
                  </div>
